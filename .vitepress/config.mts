...
export default defineConfig({
  ...
  lang: 'en-GB',
  description: 'The Information and Communications Technology Association of Zambia Act, 2018',
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'Part 2 » The Information and Communications Technology Association of Zambia', link: '/part-2' },
          { text: 'Part 3 » Executive Council of the Association', link: '/part-3' },
          { text: 'Part 4 » Membership Registration Board', link: '/part-4' },
          { text: 'Part 5 » Membership, Registration and Practising Certificate', link: '/part-5' },
          { text: 'Part 6 » Regions and Branches', link: '/part-6' },
          { text: 'Part 7 » Professional Ethics and Compliance Committee', link: '/part-7' },
